...
**Definition (Parametric Model):** Let $\Theta \subseteq \mathbb{R}^n$ is a parameter space. A family of probability distributions $\mathcal{P}_{\Theta} = \{ p_{\theta} \mid \theta \in \Theta \}$ on a measurable space is called a parametric model.
